...
from PVM_PyCUDA import TransformMotionIntegrationPVM
...
def main(epochs):
    ...
    path = '/media/sdb/'
    train_filename = path + 'PVM_movement_integration_test_set_96h_by_128w.hdf5'
    test_filename = path + 'PVM_movement_integration_train_set_96h_by_128w.hdf5'
    ...
    pvm = TransformMotionIntegrationPVM(connect_dict, flat_map, 128,  # width of the image is 128 pixels
                                        norm=255.,
    ...
    pvm.adam_train_and_validate(train_data,
                                ...
                                filename=path +
                                         '/MotionIntegration/' +
                                         'swap_foveated_no_transfer_transform_motion_integration_adam_1_pixel_per_unit_hidden_5_epochs_' +
                                         str(epochs),
